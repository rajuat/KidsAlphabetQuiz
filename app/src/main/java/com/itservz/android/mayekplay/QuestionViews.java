...
/**
 * Created by raju.athokpam on 13-09-2016.
 */
public class QuestionViews {
    ...
    public static List<ImageView> getViews10(View view16) {
        ...
        ImageView view167 = (ImageView) view16.findViewById(R.id.prep167);view167.setImageResource(R.drawable.filler);
        ImageView view168 = (ImageView) view16.findViewById(R.id.prep168);view168.setImageResource(R.drawable.filler);
        ...
        ImageView view1612 = (ImageView) view16.findViewById(R.id.prep1612);view1612.setImageResource(R.drawable.filler);
        ...
        views16.add(3, view164);
        //views16.add(4, view165);
        views16.add(4, view166);
        //views16.add(6, view167);
        //views16.add(7, view168);
        //views16.add(8, view169);
        //views16.add(9, view1610);
        views16.add(5, view1611);
        //views16.add(11, view1612);
        views16.add(6, view1613);
        views16.add(7, view1614);
        views16.add(8, view1615);
        views16.add(9, view1616);
        return views16;
    }
    ...
    public static List<ImageView> getViews11(View view16) {
        ...
        //views16.add(4, view165);
        views16.add(4, view166);
        views16.add(5, view167);
        views16.add(6, view168);
        //views16.add(8, view169);
        views16.add(7, view1610);
        views16.add(8, view1611);
        views16.add(9, view1612);
        //views16.add(12, view1613);
        //views16.add(13, view1614);
        //views16.add(14, view1615);
        views16.add(10, view1616);
        return views16;
    }
    ...
    public static List<ImageView> getViews12(View view16) {
        ...
        //views16.add(4, view166);
        //views16.add(5, view167);
        views16.add(5, view168);
        views16.add(6, view169);
        //views16.add(7, view1610);
        //views16.add(8, view1611);
        views16.add(7, view1612);
        views16.add(8, view1613);
        views16.add(9, view1614);
        views16.add(10, view1615);
        views16.add(11, view1616);
        return views16;
    }
    ...
    public static List<ImageView> getViews13(View view16) {
        ...
        views16.add(3, view164);
        views16.add(4, view165);
        //views16.add(5, view166);
        views16.add(5, view167);
        views16.add(6, view168);
        //views16.add(8, view169);
        views16.add(7, view1610);
        //views16.add(10, view1611);
        views16.add(8, view1612);
        views16.add(9, view1613);
        views16.add(10, view1614);
        views16.add(11, view1615);
        views16.add(12, view1616);
        return views16;
    }
    ...
    public static List<ImageView> getViews14(View view16) {
        ...
        //views16.add(6, view167);
        views16.add(6, view168);
        views16.add(7, view169);
        //views16.add(9, view1610);
        views16.add(8, view1611);
        views16.add(9, view1612);
        views16.add(10, view1613);
        views16.add(11, view1614);
        views16.add(12, view1615);
        views16.add(13, view1616);
        return views16;
    }
    ...
    public static List<ImageView> getViews15(View view16) {
        ...
        views16.add(8, view169);
        //views16.add(9, view1610);
        views16.add(9, view1611);
        views16.add(10, view1612);
        views16.add(11, view1613);
        views16.add(12, view1614);
        views16.add(13, view1615);
        views16.add(14, view1616);
        return views16;
    }
